...
void Render::Vulkan::VulkanSwapChain::InitSurface(CAMetalLayer* metalLayer)
{
    VkResult err = VK_SUCCESS;
...
void Render::Vulkan::VulkanSwapChain::SetContext(VkInstance instance, VkPhysicalDevice physicalDevice, VkDevice device)
{
...
void Render::Vulkan::VulkanSwapChain::Create(uint32_t width, uint32_t height, bool vsync, bool fullScreen)
{
...
VkResult Render::Vulkan::VulkanSwapChain::QueuePresent(VkQueue queue, uint32_t imageIndex, VkSemaphore waitSemaphore)
{
...
void Render::Vulkan::VulkanSwapChain::CleanUp()
{
